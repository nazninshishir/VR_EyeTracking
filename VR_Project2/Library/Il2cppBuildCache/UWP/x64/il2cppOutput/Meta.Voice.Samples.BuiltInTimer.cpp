...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TimerController_Log_mA4230F4D69BEC5439F2DEBFC376C5678DCE4EE9A (TimerController_t7771205E9B5A99CAE3C6624AB00FE8F8DB21850A* __this, String_t* ___0_msg, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_1);
		VirtualActionInvoker1< String_t* >::Invoke(73 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_1, L_2);
		// }
		return;
	}
}
...
IL_0013:
	{
		...
		double* L_2 = (double*)(&__this->____time_4);
		bool L_3;
...
{
	{
		...
		NullCheck(L_0);
		VirtualActionInvoker1< String_t* >::Invoke(73 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_0, L_2);
		// }
		return;
	}
}
